package com.javinindia.individualsellerpartner.constantSeller;

public class Constants {
    public static final String NEW_BASE_URL = "http://hnwkart.com/individual_seller/";
    ...
    public static final String SCAN_AADHAR_URL = Constants.NEW_BASE_URL + "scanAdhar.php";
