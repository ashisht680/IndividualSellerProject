...
import com.javinindia.individualsellerpartner.recyclerviewSeller.OfferAdapter;
 ...
 */
public class AllSellerOffersFragment extends SellerBaseFragment implements OfferAdapter.MyClickListener, SellerUpdateOfferFragment.OnCallBackUpdateOfferListener {
    ...
    private void initializeMethod(View view) {
        ...
        adapter.setMyClickListener(AllSellerOffersFragment.this);
