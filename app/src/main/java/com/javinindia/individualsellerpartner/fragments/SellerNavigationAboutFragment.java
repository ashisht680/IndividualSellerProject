...
import com.javinindia.individualsellerpartner.Sellerapiparsing.offerListparsing.OfferListResponseparsing;
import com.javinindia.individualsellerpartner.Sellerapiparsing.shoperprofileparsing.ShopViewResponse;
...
import com.javinindia.individualsellerpartner.picassoSeller.CircleTransform;
import com.javinindia.individualsellerpartner.preferenceSeller.SharedPreferencesManager;
import com.javinindia.individualsellerpartner.recyclerviewSeller.AboutAdaptar;
 ...
 */
public class SellerNavigationAboutFragment extends SellerBaseFragment implements View.OnClickListener, AboutAdaptar.MyClickListener, AddNewSellerOfferFragment.OnCallBackAddOfferListener, SellerEditProfileFragment.OnCallBackEditProfileListener, SellerUpdateOfferFragment.OnCallBackUpdateOfferListener, AllSellerOffersFragment.OnCallBackRefreshListener, AddSellerSubCatFragment.OnCallBackCAtegoryListener, SellerCheckConnectionFragment.OnCallBackInternetListener {
    ...
    private void setupDrawerLayout(View view) {
        ...
        if (!TextUtils.isEmpty(SharedPreferencesManager.getOwnerName(activity))) {
            txtOwnerName.setText(SharedPreferencesManager.getOwnerName(activity));
        }
    ...
    private void displayView(CharSequence title) {
        if (CheckConnection.haveNetworkConnection(activity)) {
            if (title.equals("Home")) {
                ...
                activity.finish();
            } else if (title.equals("Upload Aadhar")) {
                drawerLayout.closeDrawers();
                ScanAadharCardfragment visitCustomerFragment = new ScanAadharCardfragment();
               // categoryFragment.setMyCallBackCategoryListener(this);
                callFragmentMethod(visitCustomerFragment, this.getClass().getSimpleName(), R.id.container);
            } else if (title.equals("Add Category")) {
                drawerLayout.closeDrawers();
                AddSellerSubCatFragment categoryFragment = new AddSellerSubCatFragment();
                categoryFragment.setMyCallBackCategoryListener(this);
                callFragmentMethod(categoryFragment, this.getClass().getSimpleName(), R.id.container);
            } else if (title.equals("Add Offer")) {
                drawerLayout.closeDrawers();
                AddNewSellerOfferFragment fragment = new AddNewSellerOfferFragment();
                ...
                drawerLayout.closeDrawers();
                SellerListShopProductCategoryFragment fragment = new SellerListShopProductCategoryFragment();
                callFragmentMethod(fragment, this.getClass().getSimpleName(), R.id.container);
            } else if (title.equals("Looking For(Up coming)")) {
                drawerLayout.closeDrawers();
                Seller_looking_for_fragment fragment = new Seller_looking_for_fragment();
                callFragmentMethod(fragment, this.getClass().getSimpleName(), R.id.container);
            } else if (title.equals("About App")) {
                drawerLayout.closeDrawers();
                AboutApplicationFragments fragment = new AboutApplicationFragments();
                callFragmentMethod(fragment, this.getClass().getSimpleName(), R.id.container);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_changePass:
                SellerChangePasswordFragment fragment = new SellerChangePasswordFragment();
                callFragmentMethod(fragment, this.getClass().getSimpleName(), R.id.container);
                drawerLayout.closeDrawers();
                return true;
            case R.id.action_feedback:
                SellerFeedbackFragment fragment1 = new SellerFeedbackFragment();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (status.equalsIgnoreCase("true")) {
                            ...
                            adapter.setMyClickListener(SellerNavigationAboutFragment.this);
    ...
    public void onEditClick(int position) {
        if (CheckConnection.haveNetworkConnection(activity)) {
            SellerEditProfileFragment fragment1 = new SellerEditProfileFragment();
    ...
    public void onAllOffers(int position) {
        if (CheckConnection.haveNetworkConnection(activity)) {
            AllSellerOffersFragment fragment1 = new AllSellerOffersFragment();
    ...
    public void onOfferClick(int position, DetailsList detailsList) {
        ...
        SellerOfferPostFragment fragment1 = new SellerOfferPostFragment();
    ...
    public void onOfferEditClick(int position, DetailsList detailsList) {
        ...
        SellerUpdateOfferFragment fragment1 = new SellerUpdateOfferFragment();
    ...
    public void onViewClick(int position, DetailsList detailsList) {
        if (CheckConnection.haveNetworkConnection(activity)) {
            ...
            if (!TextUtils.isEmpty(numView) && !numView.equals("0")) {
                AllSellerViewUserFragment fragment1 = new AllSellerViewUserFragment();
                Bundle bundle = new Bundle();
                bundle.putString("offerId", offerId);
                fragment1.setArguments(bundle);
                callFragmentMethod(fragment1, this.getClass().getSimpleName(), R.id.container);
